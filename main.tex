...
\definecolor{rouge}{RGB}{148, 49, 43}
\definecolor{enhanced}{RGB}{128, 177, 211}
\definecolor{suppressed}{RGB}{255, 170, 90}
...
\hypersetup{linkcolor=RoyalBlue!50!black}
\hypersetup{urlcolor=RoyalBlue!50!black}
\hypersetup{citecolor=RoyalBlue!50!black}
}
...
\include{Chapters/Chapter_TaskEffects}

% Ch2. stimulus optimization for neural populations (simulations)
\include{Chapters/Chapter_NeuralOptimization}


% Ch3. Tuning for Image statistics in V4/V1 (MAPS)
\include{Chapters/Chapter_MultidimensionalFeatureTuning} 
